...
- 回答中請自然標示依據來源，例如 ADA 2026、KDIGO、AACE 或知識庫中出現的指南名稱；不要編造未出現在已載入內容中的來源。
...
def select_guideline_hits(
    ...
    system_text = (
        ...
        "若 CKD/eGFR/albuminuria/UACR/finerenone/腎臟問題有 KDIGO 候選，請優先檢查並保留 KDIGO，因為腎臟病分期、eGFR、albuminuria 與腎臟保護治療通常以 KDIGO 較完整；再搭配 ADA/AACE 的糖尿病用藥與整體照護內容。若內容不足以完整回答，answerable 必須是 false。"
