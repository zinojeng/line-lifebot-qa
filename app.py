...
APP_VERSION = os.getenv("APP_VERSION", "2026-05-14-compiled-guideline-artifacts-v28")
...
- 背景知識可能包含 compiled guideline artifacts，這些是從已上傳 Markdown 指南預先編譯出的 recommendation/table/section 證據卡；它們可用來快速定位證據，但若有父層章節或原始片段，仍以原始 Markdown 指南內容為準。
